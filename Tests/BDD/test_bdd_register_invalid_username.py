...
@scenario('../../features/registerUser.feature', 'Invalid user registration form - username')
def test_publish():
    pass
...
def verify_message(page):
    ...
    expect(page.locator("span[id='customer.username.errors']")).to_have_text(f"This username already exists.")  
